...
-- function combine_creature() CHANGED
...
AbilityData =
{
	...
	{ ABT_Ability, 	"AutoDefense", 		1, 	15, 	0, 	5 }, --CHANGED
...
for n, ab in pairs(AbilityData) do -- CHANGED
...
for index, part in pairs(BodyPartsThatCanHaveRange) do -- CHANGED
...
setgameattribute("Power", power); -- CHANGED
